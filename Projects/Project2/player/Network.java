...
public class Network {	
	...
	private final static int DOWN = 7;
	private final static int LEFT = 4;
	private final static int RIGHT = 5;
	private final static int UPL = 1;
	private final static int UPR = 3;
	private final static int DOWNL = 6;
	private final static int DOWNR = 8;
	 ...
	 * @param color the color we are looking for
	 * @return returns the possible networks
	 */
	...
	private static SList getNetworks(Board board, int color) {
		...
		try {
			...
			System.out.println(e + "In getNetworks");
		}
	 ...
	 * @param networkPositions list of the possible networks
	...
	private static boolean checkValidNetwork(Board board, SList networkPositions) {
		try {
			...
			System.out.println(e + "In checkValidNetwork");
		}
		return true;
	}
	...
	private static void makeConnection(Board board, int color, SList network) {
		try {
			...
			// If the last piece is an end goal piece, put it on the possibleNetwork
			...
			System.out.println(e + "In makeConnection");
		}
	}
	...
	/**
	 * If the current position is in a goal spot
	 * @param color color of the player
